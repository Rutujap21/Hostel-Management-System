...
$aid=$_SESSION['id'];
$udate=date('Y-m-d');
$query="update rector set email=? where id=?";
...
$ai=$_SESSION['id'];
$udate=date('Y-m-d');
	$sql="SELECT password FROM rector where password=?";
	...
	if($row_cnt>0)
	{
		$con="update rector set password=?  where id=?";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Rector Profile</h2>
	<?php	
$aid=$_SESSION['id'];
	$ret="select * from rector where id=?";
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">Rector profile details</div>
