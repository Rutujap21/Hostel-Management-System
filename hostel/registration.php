...
$query="insert into  userRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email,Mark,password) values(?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisis',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$Mark,$password);
$stmt->execute();
