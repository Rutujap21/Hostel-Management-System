						...
						<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<div class="stat-panel-number h1 ">Suggestion Box</div>
													
												</div>
											</div>
											<a href="suggestion.php" class="block-anchor panel-footer text-center">Add Suggestion &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
