...
$stmt=$mysqli->prepare("SELECT username,email,password,id FROM rector WHERE (userName=?|| email=?) and password=? ");
   ...
   // $stmtins->bind_param('sH',$id,$uip);
    //$res=$stmtins->execute();
					header("location:rector-profile.php");
				}
...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/.jpg);">
		<div class="form-content">
			...
			<div class="container">
				...
				<div class="row">
					...
					<h2 class="page-title text-center">Rector Login </h2>
