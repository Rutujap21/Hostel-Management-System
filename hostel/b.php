...
if(!empty($_POST["roomno"]))  //1.change name roomno from html form to something else like room also change from here 
{
	...
	if( $rowcount<3)
    {
     	echo "<span style='color:red'>Seats are Available</span>";
    }else{
...
{
echo"<script>alert('Your data is not submitted You should choose another room ');</script>";}
}
...
<div class="col-sm-8">
<input type="number" name="Mark" id="Mark"  class="form-control" value="<?php echo $row->Mark;?>"  readonly>
</div>
</div>
