...
$h_Name=$_POST['h_Name'];
$fees=$_POST['fees'];
$sql="SELECT h_Name FROM hostel where h_Name=?";
$stmt1 = $mysqli->prepare($sql);
$stmt1->bind_param('s',$h_Name);
$stmt1->execute();
$stmt1->store_result(); 
...
{
$query="insert into  hostel (h_Name,fees) values(?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('si',$h_Name,$fees);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" class="form-control" name="h_Name" id="h_Name" value="" required="required">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Fees per student</label>
<div class="col-sm-8">
